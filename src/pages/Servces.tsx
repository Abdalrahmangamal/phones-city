        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(33, 28, 77, 0) 1.44%, rgba(33, 28, 77, 0.2) 32.21%, #211C4D 100%)",
              }}
            ></div>

            {/* Text Content - Responsive for mobile, without align-items and with correct padding */}
            <div
              className="absolute inset-0 flex flex-col justify-center text-right p-4 md:p-0"
              style={{
                width: "100%",
                height: "100%",
                paddingRight: "57px",
            ...
            >
              <h1 className="text-white font-roboto font-bold text-3xl md:text-5xl leading-[48px] md:leading-[68px] mb-2 md:mb-4 text-right">
                كل ما تحتاجه في مدينه الهواتف
              </h1>
              <p className="text-white font-roboto font-bold text-base leading-6 text-right">
                استمتع بتجربة استثنائية معاحسن العروض بأفضل الأسعار وخدمة ما بعد
                البيع المميزة
              </p>
            </div>
          </div>
            ...
            <div className="hidden md:flex gap-[54px]">
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  background:
                    "linear-gradient(180deg, #F9F9F9 0%, #CBD7F9 100%)",
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  >
                    عبر منصات (تمارا - تابي - أموال - مدفوع - إمكان - مورا -
                    كوارا - MISPay) بدون دفعة اولي .
                  </p>
                </div>
              </div>
          ...
          <div className="w-full flex justify-center">
            ...
            <div className="flex flex-col gap-8 md:hidden">
              ...
              <div
                className="rounded-lg p-8 w-full max-w-[392px] h-[484px] rounded-[8px] bg-[] relative overflow-hidden mx-auto"
                style={{
