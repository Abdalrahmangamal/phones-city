...
const Filter: React.FC<FilterProps> = ({ onSortChange, onCategoryChange, categories }) => {
  ...
  return (
    <div className="w-[300px]" dir="rtl">
      ...
      <div 
        className={`w-[300px] border border-gray-200 bg-white transition-all duration-300 overflow-hidden ${
      ...
      >
        <div className="w-full h-[40px] flex justify-between items-center px-2 bg-[#FDFDFD] border-b border-gray-100">
          ...
          <ChevronDown 
            className={`w-4 h-4 text-[#211C4D] transition-transform cursor-pointer ${
