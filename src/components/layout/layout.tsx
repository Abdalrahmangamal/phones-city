    ...
    <DropdownMenuGroup>
      ...
      <DropdownMenuSub>
        ...
        <DropdownMenuSubContent dir="rtl">
          ...
          <DropdownMenuItem className="text-right">أجهزة شاومي</DropdownMenuItem>
          <DropdownMenuItem className="text-right">أجهزة إنفينكس</DropdownMenuItem>
          <DropdownMenuItem className="text-right">أجهزة تكنو</DropdownMenuItem>
          <DropdownMenuItem className="text-right">أجهزة أوبو</DropdownMenuItem>
          <DropdownMenuItem className="text-right">أجهزة هواوي</DropdownMenuItem>
          <DropdownMenuItem className="text-right">أجهزة أندرويد أخرى</DropdownMenuItem>
        </DropdownMenuSubContent>
      </DropdownMenuSub>
