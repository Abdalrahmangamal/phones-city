      ...
      <div className="relative my-6">
        ...
        >
          {categories.map((cat, index) => (
            ...
            >
              <div className="w-[100px] h-[100px] sm:w-[110px] sm:h-[110px] md:w-[120px] md:h-[120px] lg:w-[140px] lg:h-[140px] shadow-[0px_7px_29px_0px_rgba(100,100,111,0.2)] rounded-full flex items-center justify-center bg-white overflow-hidden">
                <img
                  src={cat.image}
                  alt={cat.title}
              ...
              <h2 className="text-[#211C4D] text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] font-[600] mt-2 text-center leading-tight">
                {cat.title}
              </h2>
            </SwiperSlide>
          ))}
