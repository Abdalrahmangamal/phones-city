...
const AppDownloadSection = () => {
    ...
    const { data, loading, error, fetchDownloadData, getTranslatedTitle, getTranslatedDescription } = useDownloadStore(); 
    ...
    }, [data, loading, fetchDownloadData]); 
        ...
        <div className="w-full">
            ...
            <div className="md:hidden bg-white py-8 pb-0 md:pb-8 px-4 mt-6">
                <div className="flex flex-col items-center text-center">
                    <h2 className="font-roboto font-bold text-xl sm:text-2xl text-[15px] text-[#211C4D] mb-3" dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
                        {appTitle}
                    </h2>
                    <p className="font-roboto font-medium text-base sm:text-lg text-[12px] text-[#211C4D] mb-6" dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
                        {appDescription}
                    </p>
