      ...
      >
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="mb-4 rounded-2xl bg-[#FAFAFA] p-4 md:p-6">
            <h3 className="mb-4 text-xl md:text-2xl font-bold text-[#211C4D]">الية الاستخدام</h3>
            <div className="space-y-3">
              {usageSteps.map((step, index) => (
                <div key={index} className="flex items-start gap-2">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#211C4D]">{step}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mb-4 rounded-2xl bg-[#FAFAFA] p-4 md:p-6">
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div>
                <h4 className="mb-2 text-lg md:text-xl font-bold text-[#211C4D]">يثق بنا الملايين</h4>
          ...
          <div className="mb-6 rounded-2xl bg-[#FAFAFA] p-4 md:p-6">
            <div className="flex items-start gap-3 md:gap-4">
              <div className="rounded-full bg-[#2A255B0D] p-2">
                <ShoppingCart className="h-5 w-5 text-[#211C4D]" />
              </div>
              <div>
                <h4 className="mb-2 text-lg md:text-xl font-bold text-[#211C4D]">تسوّق بأمان مع تابي</h4>
                <p className="text-[#211C4D80] text-sm md:text-base">
